...
app.get('/get', function(req, res) {
	...
	client.get("2", function(err,value){ 
		if(value)
		{
			...
			res.send("Value exists at port "+process.argv[2]+" : "+value);
		}
			
		else
		{
			console.log("Value expired.");
			res.send("Value expired."+ process.argv[2]);
		}	
		res.end();
	});
})
...
// Image Upload and Retrieve
 ...
 app.get('/meow', function(req, res) {
 	client.lpop('images', function(err, imagedata){
    	...
    	res.write("<h1>\n<img src='data:"+imagedata+".jpg;base64,"+imagedata+"'/>");
...
app.get('/', function(req, res) {
  res.send('Hello Ravina at '+process.argv[2]+'!')
})
/////////////////////////////////////////////////////////////////
